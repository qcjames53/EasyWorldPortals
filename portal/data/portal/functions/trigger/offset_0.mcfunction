...
# Facing -z (north)
execute if score #dir_chosen v matches 0 if score #temp_z v > #source_z_width \
    v run function portal:trigger/offset_0_north
...
# Facing -x (west)
execute if score #dir_chosen v matches 0 if score #temp_x v > #source_x_width \
    v run function portal:trigger/offset_0_west