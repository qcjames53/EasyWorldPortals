# Teleports the player from the source trigger to the destination trigger, respecting all offsets.
...
data modify storage minecraft:portal input.offset_x set string storage minecraft:portal \
    input.offset_x 0 -1
data modify storage minecraft:portal input.offset_y set string storage minecraft:portal \
    input.offset_y 0 -1
data modify storage minecraft:portal input.offset_z set string storage minecraft:portal \
    input.offset_z 0 -1

# debug offset display
#tellraw @a [{"text":"Offset: "},{"storage":"minecraft:portal","nbt":"input.offset_x"},\
#    {"text":" "},{"storage":"minecraft:portal","nbt":"input.offset_y"},{"text":" "},\
...
$execute if entity @s[tag=iz_source] as @e[tag=trigger,scores={trigger_id=$(tp_id)},limit=1] at @s \
    run function portal:trigger/tp_1 with storage minecraft:portal
