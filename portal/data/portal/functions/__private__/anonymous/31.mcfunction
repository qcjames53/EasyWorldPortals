...
execute if score @s portal_width matches 4 run function portal:__private__/anonymous/29
execute if score @s portal_width matches 5 run function portal:__private__/anonymous/30
