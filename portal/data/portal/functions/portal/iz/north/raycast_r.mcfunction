...
execute if score #rc_depth v matches 1.. if score #rc_x v matches ..-16 \
    positioned ~1 ~ ~ rotated 180 ~ run function portal:portal/iz/north/raycast_r
execute if score #rc_depth v matches 1.. if score #rc_x v matches 16.. \
    positioned ~-1 ~ ~ rotated 180 ~ run function portal:portal/iz/north/raycast_r
execute if score #rc_depth v matches 1.. positioned ^ ^ ^1 run function portal:portal/iz/north/raycast_r