# Determine the boundaries of the illusion zone for east facing renders and copy
...
scoreboard players set #rc_depth v 80
$execute positioned ~-0.5 ~ ~1.5 positioned ~ ~ ~$(z_width) facing entity @p \
    feet positioned as @p rotated ~180 0 run function \
