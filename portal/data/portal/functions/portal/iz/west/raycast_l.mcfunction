# Run the left boundary raycast (recursively) to determine left-edge of 
...
execute if score #rc_x v matches ..0 run \
    function portal:portal/iz/store_coords with storage minecraft:input
...
execute if score #rc_depth v matches 1.. if score #rc_z v matches ..-16 \
    ...
    portal:portal/iz/west/raycast_l
execute if score #rc_depth v matches 1.. if score #rc_z v matches 16.. \
